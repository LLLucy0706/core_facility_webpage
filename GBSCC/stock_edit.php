...
echo "</td>";
echo "<td>";
echo "<input type=\"text\" size=\"20\" value=\"" . $result_stock_array['Spinminiprep'] . "\" name=\"Spinminiprep_stock\" id=\"Spinminiprep_stock\">";
echo "</td>";
echo "</tr>";
...
echo "</td>";
echo "<td>";
echo "<input type=\"text\" size=\"20\" value=\"" . $result_stock_array['QIAGEN_QIAquick_PCR_Purification'] . "\" name=\"QIAGEN_QIAquick_PCR_Purification_stock\" id=\"QIAGEN_QIAquick_PCR_Purification_stock\">";
echo "</td>";
echo "</tr>";
...
echo "</td>";
echo "<td>";
echo "<input type=\"text\" size=\"20\" value=\"" . $result_stock_array['QIAGEN_QIAquick_Gel_Extraction'] . "\" name=\"QIAGEN_QIAquick_Gel_Extraction_stock\" id=\"QIAGEN_QIAquick_Gel_Extraction_stock\">";
echo "</td>";
echo "</tr>";
...
echo "</td>";
echo "<td>";
echo "<input type=\"text\" size=\"20\" value=\"" . $result_stock_array['QIAGEN_RNeasy_Mini'] . "\" name=\"QIAGEN_RNeasy_Mini_stock\" id=\"QIAGEN_RNeasy_Mini_stock\">";
echo "</td>";
echo "</tr>";
echo "</table><br><br>";
