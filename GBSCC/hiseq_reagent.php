  ...
  <tr>
	...
	if(!$_GET['Submitter_Name']){
        ...
        if($err_count<1) {
            ...
            if (!$res){
                echo "<span style=\"font-family:sans-serif;font-size:20px;color:red\">Your request submission failed. Please contact Genomics Core Tech support: siyunliu@um.edu.mo</span>";
            }
            else{
                ...
                if($tomail!=""){
                    ...
                    if(!$mail->Send()) {
                        echo "Request email failed. Please contact Genomics Core Tech support: siyunliu@um.edu.mo<br><br>" . $mail->ErrorInfo;
                    } else {
