            ...
            <br>
                <table border="2" cellspacing="0" cellpadding="0" bordercolor="#999999">
                    ...
                    <tr height="40px">
                        ...
                        <td align="center" style="font-size:14px">sample</td>
                        <td align="center" style="font-size:14px">110.00</td>
                        <td align="center" style="font-size:14px">891.00</td>
                    </tr>
                    <tr height="40px">
                        <td style="font-size:14px;padding-left:5px">RNA-Seq, 12G Raw Data (includes library preparation)</td>
                        <td align="center" style="font-size:14px">sample</td>
                        <td align="center" style="font-size:14px">170.00</td>
                        <td align="center" style="font-size:14px">1377.00</td>
                    </tr>
                    <tr height="40px">
                        <td style="font-size:14px;padding-left:5px">ChIP-Seq, 6G Raw Data (includes library preparation)</td>
                        <td align="center" style="font-size:14px">sample</td>
                        <td align="center" style="font-size:14px">160.00</td>
                        <td align="center" style="font-size:14px">1296.00</td>
                    </tr>
                    <tr height="40px">
                        <td style="font-size:14px;padding-left:5px">ChIP-Seq, 12G Raw Data (includes library preparation)</td>
                        <td align="center" style="font-size:14px">sample</td>
                        <td align="center" style="font-size:14px">220.00</td>
                        <td align="center" style="font-size:14px">1782.00</td>
                    </tr>
                </table>
            <br>
            <ul>
