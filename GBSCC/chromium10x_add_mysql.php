...
if (!$res) {
    echo "<br><b><span style=\"font-family:sans-serif;font-size:20px;color:red\">Your request submission failed. Please contact Genomics Core support: siyunliu@um.edu.mo</span></b>";
} else {
