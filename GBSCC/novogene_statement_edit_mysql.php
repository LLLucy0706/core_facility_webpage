...
if (!$res) {
    echo "<br><br><b><span style=\"font-family:sans-serif;font-size:20px;color:red\">Deposit failed to added. Please contact Genomics Core support: siyunliu@um.edu.mo</span></b>";
} else {
